...
(function($) {
    ...
    var methods = {
        ...
        initIndent: function() {
            ...
            for (var i = 0; i < $(this).treegrid('getGroph'); i++) {
        ...
        getGroph: function() {
            ...
            return $(this).treegrid('getParentNode').treegrid('getGroph') + 1;
        },
        /**
         ...
         */
        isRoot: function() {
            return $(this).treegrid('getGroph') === 0;
        },
        /**
