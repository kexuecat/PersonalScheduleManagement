package cn.ghy.ps.common.utils.ftp;
...
public class FtpUtil{
    ...
    /**
     * FTP服务器文件存放路径。例如分日期存放：/2021/05/28。文件的路径为basePath+filePath
     */
    public static final String filePath = "192.168.1.119";
